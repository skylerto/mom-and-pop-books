...
public class TestBookDAO {
  ...
  @Mock
  BookDataAccessObject mockedBookDAO;
  ...
  public void setUp() throws Exception {
    ...
    mockedBookDAO = Mockito.mock(BookDataAccessObject.class);
    ...
    Mockito
        .when(
            mockedBookDAO.findByTitle("Release It!: Design and Deploy Production-Rea​dy Software"))
